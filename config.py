...
pre_db_port = '3306'
pre_db_database = 'pre_data'
pre_db_user = 'factor_edit'
pre_db_pwd = 'factor_edit_2019'

hh_db_host = '10.15.97.127'
hh_db_port = '1433'
hh_db_database = 'dnds'
hh_db_user = 'reader'
hh_db_pwd = 'reader'
...
DB_URL = 'mysql+mysqlconnector://factor_edit:tcdept_Factoredit@db1.irongliang.com:3306/vision'
