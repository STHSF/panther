...
class CalcEngine(object):
    def __init__(self, name, url,
                 methods=[{'packet': 'volatility_value.factor_volatility_value.py', 'class': 'FactorVolatilityValue'}]):
        self._name = name
    ...
    def process_calc_factor(self, packet_name, class_name, mkt_df, trade_date):
        ...
        result = pd.concat(res, axis=1).reset_index().rename(
            columns={'index': 'security_code', 'code': 'security_code'})
